...
const Cart = () => {
  ...
  return (
    <div className="flex justify-center">
      {cart && cart.length ? (
        <>
          <div className="min-h-[80vh] md:grid-cols-2 max-w-6x1 ma-auto">
          ...
          <div className="w-[300px]">
            <div className="flex flex-col justify-center items-end p-5 space-y-5 mt-14">
              <h1 className="font-bold text-red-800">Your Cart Sumary</h1>
              <p>
        ...
        <div className="min-h-[80] flex flex-col items-center justify-center">
          <h1 className="text-gray-800 font-bold text-x1 md-2">
            Tour cart is empty
          </h1>
          <Link to={"/"}>
